...
/**
 * Provides the local service interface for ImpersonationRegistry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ImpersonationRegistryLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ImpersonationRegistryLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>net.carlosduran.ell.impsb.service.impl.ImpersonationRegistryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the impersonation registry local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ImpersonationRegistryLocalServiceUtil} if injection and service tracking are not available.
	 */
