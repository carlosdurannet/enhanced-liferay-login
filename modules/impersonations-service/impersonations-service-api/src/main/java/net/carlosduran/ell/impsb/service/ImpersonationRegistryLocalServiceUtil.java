...
package net.carlosduran.ell.impsb.service;
 ...
 * <code>net.carlosduran.ell.impsb.service.impl.ImpersonationRegistryLocalServiceImpl</code> and
...
public class ImpersonationRegistryLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>net.carlosduran.ell.impsb.service.impl.ImpersonationRegistryLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static ImpersonationRegistry addImpersonationRegistry(
	 ...
	 */
	public static ImpersonationRegistry createImpersonationRegistry(
	 ...
	 */
	public static ImpersonationRegistry deleteImpersonationRegistry(
		ImpersonationRegistry impersonationRegistry) {
	...
	public static ImpersonationRegistry fetchImpersonationRegistry(
		long impersonationRegistryId) {
	 ...
	 */
	public static ImpersonationRegistry
	 ...
	 */
	public static List<ImpersonationRegistry> getImpersonationRegistries(
		int start, int end) {
	 ...
	 * @throws PortalException if a impersonation registry with the primary key could not be found
	 */
	public static ImpersonationRegistry getImpersonationRegistry(
			long impersonationRegistryId)
		throws PortalException {
	 ...
	 */
	public static ImpersonationRegistry updateImpersonationRegistry(
		ImpersonationRegistry impersonationRegistry) {
	...
	private static volatile ImpersonationRegistryLocalService _service;
