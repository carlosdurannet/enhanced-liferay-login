...
import net.carlosduran.ell.impsb.model.ImpersonationRegistryModel;

/**
 * The base model implementation for the ImpersonationRegistry service. Represents a row in the &quot;ELL_ImpersonationRegistry&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class ImpersonationRegistryModelImpl
	 ...
	 */
	public static final String TABLE_NAME = "ELL_ImpersonationRegistry";

	public static final Object[][] TABLE_COLUMNS = {
		{"uuid_", Types.VARCHAR}, {"impersonationRegistryId", Types.BIGINT},
		{"companyId", Types.BIGINT}, {"userId", Types.BIGINT},
		{"screenName", Types.VARCHAR}, {"impersonatedUserId", Types.BIGINT},
	...
	public static final String TABLE_SQL_CREATE =
		"create table ELL_ImpersonationRegistry (uuid_ VARCHAR(75) null,impersonationRegistryId LONG not null primary key,companyId LONG,userId LONG,screenName VARCHAR(75) null,impersonatedUserId LONG,impersonatedScreenName VARCHAR(75) null,operationDate DATE null,operationResult INTEGER)";

	public static final String TABLE_SQL_DROP =
		"drop table ELL_ImpersonationRegistry";

	public static final String ORDER_BY_JPQL =
		" ORDER BY impersonationRegistry.operationDate DESC";

	public static final String ORDER_BY_SQL =
		" ORDER BY ELL_ImpersonationRegistry.operationDate DESC";
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(
		net.carlosduran.ell.impsb.service.util.ServiceProps.get(
			"value.object.entity.cache.enabled.net.carlosduran.ell.impsb.model.ImpersonationRegistry"),
		true);

	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(
		net.carlosduran.ell.impsb.service.util.ServiceProps.get(
			"value.object.finder.cache.enabled.net.carlosduran.ell.impsb.model.ImpersonationRegistry"),
		true);

	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(
		net.carlosduran.ell.impsb.service.util.ServiceProps.get(
			"value.object.column.bitmask.enabled.net.carlosduran.ell.impsb.model.ImpersonationRegistry"),
		true);
	...
	public static final long OPERATIONDATE_COLUMN_BITMASK = 4L;

	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(
		net.carlosduran.ell.impsb.service.util.ServiceProps.get(
			"lock.expiration.time.net.carlosduran.ell.impsb.model.ImpersonationRegistry"));
	...
	static {
		...
		attributeGetterFunctions.put(
			...
			new Function<ImpersonationRegistry, Object>() {
				...
				public Object apply(
					...
					return impersonationRegistry.getUuid();
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<ImpersonationRegistry, Object>() {
				...
				public void accept(
					...
					impersonationRegistry.setUuid((String)uuidObject);
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<ImpersonationRegistry, Object>() {
				...
				public void accept(
					ImpersonationRegistry impersonationRegistry,
					Object impersonationRegistryIdObject) {

					impersonationRegistry.setImpersonationRegistryId(
						(Long)impersonationRegistryIdObject);
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<ImpersonationRegistry, Object>() {
				...
				public void accept(
					...
					impersonationRegistry.setCompanyId((Long)companyIdObject);
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<ImpersonationRegistry, Object>() {
				...
				public void accept(
					...
					impersonationRegistry.setUserId((Long)userIdObject);
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<ImpersonationRegistry, Object>() {
				...
				public void accept(
					ImpersonationRegistry impersonationRegistry,
					Object screenNameObject) {

					impersonationRegistry.setScreenName(
						(String)screenNameObject);
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<ImpersonationRegistry, Object>() {
				...
				public void accept(
					ImpersonationRegistry impersonationRegistry,
					Object impersonatedUserIdObject) {

					impersonationRegistry.setImpersonatedUserId(
						(Long)impersonatedUserIdObject);
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<ImpersonationRegistry, Object>() {
				...
				public void accept(
					ImpersonationRegistry impersonationRegistry,
					Object impersonatedScreenNameObject) {

					impersonationRegistry.setImpersonatedScreenName(
						(String)impersonatedScreenNameObject);
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<ImpersonationRegistry, Object>() {
				...
				public void accept(
					ImpersonationRegistry impersonationRegistry,
					Object operationDateObject) {

					impersonationRegistry.setOperationDate(
						(Date)operationDateObject);
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<ImpersonationRegistry, Object>() {
				...
				public void accept(
					ImpersonationRegistry impersonationRegistry,
					Object operationResultObject) {

					impersonationRegistry.setOperationResult(
						(Integer)operationResultObject);
				}
	...
	public ImpersonationRegistry toEscapedModel() {
		if (_escapedModel == null) {
			Function<InvocationHandler, ImpersonationRegistry>
	...
	public Object clone() {
		...
		impersonationRegistryImpl.setUuid(getUuid());
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof ImpersonationRegistry)) {
			return false;
		}

		ImpersonationRegistry impersonationRegistry =
			(ImpersonationRegistry)object;
	...
	public CacheModel<ImpersonationRegistry> toCacheModel() {
		...
		impersonationRegistryCacheModel.uuid = getUuid();

		String uuid = impersonationRegistryCacheModel.uuid;

		if ((uuid != null) && (uuid.length() == 0)) {
			impersonationRegistryCacheModel.uuid = null;
		}
