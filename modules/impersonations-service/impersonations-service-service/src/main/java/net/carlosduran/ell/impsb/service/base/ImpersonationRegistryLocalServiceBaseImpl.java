...
package net.carlosduran.ell.impsb.service.base;
...
import net.carlosduran.ell.impsb.service.ImpersonationRegistryLocalService;
import net.carlosduran.ell.impsb.service.ImpersonationRegistryLocalServiceUtil;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link net.carlosduran.ell.impsb.service.impl.ImpersonationRegistryLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see net.carlosduran.ell.impsb.service.impl.ImpersonationRegistryLocalServiceImpl
 * @generated
 */
public abstract class ImpersonationRegistryLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, ImpersonationRegistryLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ImpersonationRegistryLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ImpersonationRegistryLocalServiceUtil</code>.
	 */
	...
	public void afterPropertiesSet() {
		...
		_setLocalServiceUtilService(impersonationRegistryLocalService);
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				ImpersonationRegistryLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, impersonationRegistryLocalService);
		}
